...
class Envs:
    ...
    SGLANG_ROCM_GFX928_W8A8_QKV_PROJ_M1 = EnvBool(False)
    SGLANG_ROCM_GFX928_W8A8_O_PROJ_M1 = EnvBool(False)
    SGLANG_ROCM_GFX928_W8A8_DENSE_GATE_UP_M1 = EnvBool(False)
    SGLANG_ROCM_GFX928_W8A8_DENSE_DOWN_M1 = EnvBool(False)
    SGLANG_DEBUG_GFX928_COUNTER = EnvBool(False)
